...
\score {
   ...
   \relative c'' \sequential {
	...
	\context Staff \relative c'' <<
		...
		% second part 
		   \repeat volta 2 {
		   	\override TextSpanner   #'edge-text = #'("1/2 CV " ."")
		   	\override TextSpanner   #'style = #'line \override TextSpanner #'bound-details #'right #'text = \markup { \draw-line #'(0 . 0.5) }

			b'4 #(ly:export (make-span-event 'TextSpanEvent START))  
			g8 a b g #(ly:export (make-span-event 'TextSpanEvent STOP)) |
			\override TextSpanner   #'edge-text = #'("1/2 CIV " ."")
			a4 #(ly:export (make-span-event 'TextSpanEvent START))
			d,8 e fis d #(ly:export (make-span-event 'TextSpanEvent STOP)) |
			g4 e8 fis g d |
			cis4 b8 cis a4 |
			\break
			 a8[ b]  cis[ d]  e[ fis] |
